...
% Describes:
% \begin{itemize}
% \item Probands (studied objects): Type, number, characteristics, age,
% gender by arithmetic means and distribution
% \item materials: surveys (exemplary demonstration!) incl instructions, software used, given media (differences)
% \item Proceeding: Splitting of the group, quality of questions
% \item Evaluationmethods: methods used for evaluation (statistical tests)
% \end{itemize}
